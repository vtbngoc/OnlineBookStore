...
<body>
    ...
    <nav class="nav-underline sticky-top container-fluid mx-0 px-0">
        ...
        <div class="col-2 navbar-right">
            <ul class="navbar-icon">
                ...
                <li class="nav-icon">
                    <button type="button" class="btn icon-link icon-link-hover" id="icon-cart">
    ...
    <section class="section section-shopping-cart" id="cart-tab" data-title="Shopping cart">
        <div class="container">
            ...
            <div class="d-block">
                <div class="">
                    <div class="px-2">
                        <div class="progress" role="progressbar" aria-label="Success example" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100" style="height: 10px; background-color: #b9d6f3; margin-bottom: 12px;">
                            <div class="progress-bar bg-primary" style="width: 100%; color: white; font-size: 8px; font-weight: 500;">100%</div>
                        </div>
                        <div class="cart-promotion d-flex align-items-center justify-content-between p-2" style="background-color: #b9d6f3; border: 1px solid #27487A; border-radius: 5px;">
                            <div>
                                <i class="fa-solid fa-truck-fast"></i>
                                <strong>NTFREESHIP</strong>
                            </div>
                            <button type="button" class="btn btn-dark" style="height: 30px; padding: 3px 12px;">Copy</button>
                        </div>
                        <div class="content-promotion">
                            Congratulation! Your order is eligible for free shipping
                        </div>
                    </div>
                    <div class="list-products-cart">
                        <div class="product-cart">
                            <button type="button" class="btn-close" data-bs-dismiss="product-cart" aria-label="Close"></button>
                            <img src="images/tanktop-women-green.jfif" alt="tanktopwomen" width="90px">
                            <div class="content-product-cart d-flex justify-content-between">
                                <div class="title-product-cart white-space-nowrap" style="width: 13vw;">
                                    <h5 class="product-name"><a href="ProductDetail.jsp" class="text-decoration-none text-dark">Tank top for women</a></h5>
                                    <span>Green / S</span>
                                </div>
                                ...
                                <div class="quantity-product-cart">
                                    <h6>Quantity</h6>
                                    <input type="number" min="0" value="1" style="width: 7vw; border-radius: 5px; text-align: center; padding-left: 10px;">
                                </div>
                                <div class="total-product-cart">
                                    <h6>Total</h6>
                                    <input type="text" readonly value="40$" style="width: 7vw; border-radius: 5px; text-align: center;">
                                </div>
                            </div>
                        </div>
                        <div class="product-cart">
                            <button type="button" class="btn-close" data-bs-dismiss="product-cart" aria-label="Close"></button>
                            <img src="images/tanktop-men-dark.jfif" alt="tanktopwomen" width="90px">
                            <div class="content-product-cart d-flex justify-content-between">
                                <div class="title-product-cart white-space-nowrap" style="width: 13vw;">
                                    <h5 class="product-name"><a href="ProductDetail.jsp" class="text-decoration-none text-dark">Tank top for men</a></h5>
                                    <span>Dark / L</span>
                                </div>
                                <div class="price-product-cart">
                                    <h6>Price</h6>
                    ...
                    <div class="note-cart">
                        <h5>Order notes</h5>
                        <textarea name="note" id="note" rows="3" style="border-radius: 8px; padding: 10px; width: 100%;"></textarea>
                    </div>
                </div>
                <div class="checkout-order">
                    <form action="Checkout.jsp"><button type="submit" class="btn btn-dark w-100">Check out</button></form>
                </div>
                <!-- <div style="background-color: #f1f0f0; padding: 0px 10px;">
                    <div class="title-date" style="padding: 10px 0px; border-bottom: 1px solid #d6d6d6; color: #27487A;">
                        <h4 style="margin-bottom: 0px;">Order & Receive date</h4>
                    </div>
                    <div class="order-receive-time d-flex justify-content-between py-3" style="border-bottom: 1px solid #d6d6d6;">
                        <div class="order-date">
                            <h5>Order date</h5>
                            <input type="text" id="order-date" style="width: 150px;">
                        </div>
                        <div class="receive-date">
                            <h5>Receive date</h5>
                            <input type="text" id="receive-date" style="width: 150px;">
                        </div>
                    </div>
                    <div class="total-order d-block py-3" style="border-bottom: 1px solid #d6d6d6;">
                        <div class="d-flex justify-content-between">
                            <h4>TOTAL</h4>
                            <h4>40$</h4>
                        </div>
                        <div class="d-flex justify-content-end"><i>(VAT included if applicable)</i></div>
                    </div>
                    <div class="promotion-order d-flex justify-content-between py-3">
                        <div class="d-flex align-items-center">
                            <i class="fa-solid fa-percent" style="padding: 1px 5px; margin-right: 5px; background-color: #27487A; color: white; border-radius: 5px;"></i>
                            <h6 style="margin-bottom: 0;">Discount code</h6>
                        </div>
                        <a href="#" class="text-decoration-none text-dark">Choose discount code<i class="fa-solid fa-angle-right"></i></a>
                    </div>
                    <div class="checkout-order">
                        <button type="button" class="btn btn-dark w-100">Check out</button>
                    </div>
                </div> -->
            </div>
        </div>
