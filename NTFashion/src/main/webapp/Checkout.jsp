...
<body>
            ...
            <div class="row">
                <div class="col-12 a-left">
                    <ol class="breadcrumb m-0 px-0 py-2">
                        ...
                        <li class="breadcrumb-item"><a class="link" href="ShoppingCart.jsp"><span>Shopping cart</span></a></li>
    ...
    <section class="section section-info-order">
        <div class="container">
            <div class="row">
                <div class="col-12 col-sm-7 d-block" style="border-right: 1px solid gainsboro;">
                    <h4>Receiving information</h4>
                    <input type="email" placeholder="nguyenvana@gmail.com" title="nguyenvana@gmail.com">
                    <input type="text" placeholder="Nguyen Van A" title="Nguyen Van A">
                    <input type="text" placeholder="0123456789" title="0123456789">
                    <input type="text" placeholder="12/34 abc, Linh Trung, Thu Duc, TP.HCM" title="12/34 abc, Linh Trung, Thu Duc, TP.HCM">
                    <textarea name="note" id="note" rows="3" style="border-radius: 8px; padding: 10px; width: 100%; border: 1px solid gainsboro;" placeholder="Note here ..."></textarea>
                    <div class="payment-method">
                        <h4>Payment method</h4>
                        <div class="d-flex" style="gap: 8px; align-items: center;">
                            <input type="radio" name="paymentmethod" value="COD" checked style="width: 20px; margin-bottom: 0px;">
                            <h6 style="margin-bottom: 0px;">Payment COD</h6>
                        </div>
                        <div class="d-flex" style="gap: 8px; align-items: center;">
                            <input type="radio" name="paymentmethod" value="MOMO" style="width: 20px; margin-bottom: 0px;">
                            <h6 style="margin-bottom: 0px;">Payment MoMo</h6>
                        </div>
                        <div class="d-flex" style="gap: 8px; align-items: center;">
                            <input type="radio" name="paymentmethod" value="VNPay" style="width: 20px; margin-bottom: 0px;">
                            <h6 style="margin-bottom: 0px;">Payment VNPay</h6>
                        </div>
                    </div>
                    <div class="d-flex justify-content-between" style="background-color: gainsboro; border-radius: 7px;">
                        <form action="ShoppingCart.jsp">
                            <button type="submit" class="btn"><i class="fa-solid fa-angle-left" style="padding-right: 5px;"></i>Back</button>
                        </form>
                        <form action="PaymentMethod.jsp">
                            <button type="submit" class="btn btn-dark">Order<i class="fa-solid fa-angle-right" style="padding-left: 5px;"></i></button>
                        </form>
                    </div>
                </div>
                <div class="col-12 col-sm-5 d-block" style="background-color: white;">
                    <h4 style="border-bottom: 1px solid gainsboro;">Order</h4>
                    <table class="w-100" style="border-bottom: 1px solid gainsboro;">
                        <thead>
                            <tr>
